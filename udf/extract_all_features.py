...
for row in sys.stdin:
    ...
    if textual == '0':
      ...
      features.append("other_i_mean_discourse_" + get_bucket(min_i_mean_discourse, max_i_mean_discourse, other_i_mean_discourse))
      features.append("self_sex_" + get_bucket(min_sex, max_sex, self_sex))
      features.append("other_sex_" + get_bucket(min_sex, max_sex, other_sex))
      features.append("self_meta_" + get_bucket(min_meta, max_meta, self_meta))
      features.append("other_meta_" + get_bucket(min_meta, max_meta, other_meta))
      features.append("self_negate_" + get_bucket(min_negate, max_negate, self_negate))
      features.append("other_negate_" + get_bucket(min_negate, max_negate, other_negate))
      features.append("self_um_discourse_" + get_bucket(min_um_discourse, max_um_discourse, self_um_discourse))
      features.append("other_um_discourse_" + get_bucket(min_um_discourse, max_um_discourse, other_um_discourse))
      features.append("self_negemo_" + get_bucket(min_negemo, max_negemo, self_negemo))
      features.append("other_negemo_" + get_bucket(min_negemo, max_negemo, other_negemo))
      features.append("self_appreciation_" + get_bucket(min_appreciation, max_appreciation, self_appreciation))
      features.append("other_appreciation_" + get_bucket(min_appreciation, max_appreciation, other_appreciation))
      ...
      features.append("other_tot_question_words_" + get_bucket(min_tot_question_words, max_tot_question_words, other_tot_question_words))
      ...
      features.append("other_you_know_discourse_" + get_bucket(min_you_know_discourse, max_you_know_discourse, other_you_know_discourse))
      features.append("self_hate_" + get_bucket(min_hate, max_hate, self_hate))
      features.append("other_hate_" + get_bucket(min_hate, max_hate, other_hate))
      features.append("self_food_" + get_bucket(min_food, max_food, self_food))
      features.append("other_food_" + get_bucket(min_food, max_food, other_food))
      features.append("self_uh_discourse_" + get_bucket(min_uh_discourse, max_uh_discourse, self_uh_discourse))
      features.append("other_uh_discourse_" + get_bucket(min_uh_discourse, max_uh_discourse, other_uh_discourse))
      features.append("self_you_" + get_bucket(min_you, max_you, self_you))
      features.append("other_you_" + get_bucket(min_you, max_you, other_you))
      features.append("self_I_" + get_bucket(min_I, max_I, self_I))
      features.append("other_I_" + get_bucket(min_I, max_I, other_I))
      features.append("self_drink_" + get_bucket(min_drink, max_drink, self_drink))
      features.append("other_drink_" + get_bucket(min_drink, max_drink, other_drink))
      features.append("self_like_discourse_" + get_bucket(min_like_discourse, max_like_discourse, self_like_discourse))
      features.append("other_like_discourse_" + get_bucket(min_like_discourse, max_like_discourse, other_like_discourse))
      features.append("self_hedge_" + get_bucket(min_hedge, max_hedge, self_hedge))
      features.append("other_hedge_" + get_bucket(min_hedge, max_hedge, other_hedge))
      features.append("self_academics_" + get_bucket(min_academics, max_academics, self_academics))
      features.append("other_academics_" + get_bucket(min_academics, max_academics, other_academics))
      features.append("self_laughter_" + get_bucket(min_laughter, max_laughter, self_laughter))
      features.append("other_laughter_" + get_bucket(min_laughter, max_laughter, other_laughter))
